...
3. Add tests for behavior changes, especially durability and authentication boundaries.
4. Keep the edge runtime dependency-light. New dependencies need a clear maintenance/security reason.
5. Open a pull request describing the failure mode or use case, the change, and how it was tested.
