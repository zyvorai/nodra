...
code="$(curl_nodra -sS -o "${TMP}/nodra-login.json" -w '%{http_code}' \
...
code="$(curl_nodra -sS -o "${TMP}/nodra-metrics.txt" -w '%{http_code}' "${BASE}/metrics")"
