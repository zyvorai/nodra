# Industrial protocol increment — Nodra v0.2.1
...
### Raw + decoded duplication

If `j1939-device-agent` consumes the Device Agent SSE stream, set Device Agent
